...
export default function Home() {
  ...
  // create an accordion with tailwind for each item in text, which has a title and content elements
  // only show content when the item is opened, and hide it when closed. Default to the first item as opened
  return (
